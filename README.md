...
请使用 melo-tts-metadata-creator 技能，将音频目录"F:\命理学-音频-干声-切片"和文本目录"F:\命理学-音频-干声-切片-文本_corrected_punctuated"生成 metadata.list 文件，输出到F:\命理学-数据集\metadata.list，添加参数 --txt_dir --lang ZH --recursive --use_whisper
